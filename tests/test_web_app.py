...
class WebApplicationTests(unittest.TestCase):
    ...
    def test_stub_source_empty_run_is_not_connected_in_sources_api(self) -> None:
        ...
        maya = next(
            ...
            if record["name"] == "maya_announcements"
        )
        self.assertEqual(maya["status"], "stub")
        self.assertNotEqual(maya["status"], "connected")
        self.assertIsNone(maya["latest_success"])
