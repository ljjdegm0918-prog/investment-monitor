...
# 也绝不能把 UI/API 状态抬成 connected。已在本分支接通真实采集能力的
# NewsWeb、Euronext Lisbon、Vienna、BMV、MAYA 与 Budapest 不属于此集合。
...
SOURCE_LABELS = {
    ...
    "eurex_circulars": "Eurex Circulars & Newsflashes",
    "nasdaq_se_filings": "Nasdaq Nordic Company News (Sweden)",
    "gpw_espi": "GPW ESPI/EBI",
    "eqs_dgap": "EQS News (DGAP)",
    "afm_nl": "AFM inside-information register",
    "eqs_nl": "EQS News (NL)",
    "wiener_boerse_news": "Wiener Börse Ad-hoc News",
...
CONNECTOR_REGIONS = {
    ...
    "fi_oam": ("Sweden",),
    "nasdaq_se_filings": ("Sweden",),
    "eurex_circulars": ("Eurex",),
    "yahoo_se": ("Sweden",),
    ...
    def connector_statuses(
        ...
        *,
        ...
        for source in self._connector_catalog:
            ...
            latest_success = (
                None
                if is_stub_source or bounded_incomplete
                else (
