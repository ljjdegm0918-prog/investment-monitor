...
Sydney day + normalized title) so no cross-source filing pairing can
happen; AU news (yahoo_au / google_news_au) pairs across sources on ticker
+ Sydney day + normalized title.
"""
