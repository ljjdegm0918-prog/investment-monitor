...
MARKET_NOTES = {
    ...
    "CH": "SIX public FQS JSON now provides Swiss Shares, Foreign Shares, Sponsored Foreign Shares and ETF trading-line metadata with strict pagination. SIX Exchange Regulation Official Notices adds key-free total-count list/detail JSON matched by exact ISIN; the coverage boundary still excludes historical/delisted securities and full ad-hoc/financial-report equivalence, while BATECH/CHIXCH/TRQXCH/VIRTX remain routing venues rather than duplicate issuer masters",
