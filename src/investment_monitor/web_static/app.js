...
const MARKET_HINTS = {
  ...
  aq: "AQ market (Aquis Stock Exchange, AQSE): root tickers strip .AQ; AQSE mnemonics kept as-is; ISINs (GB/IE/other) kept as-is. Companies are added as unmapped (no SEC mapping). Disclosure is NOT wired (AQ-1 A3: official aquis.eu pages sit behind a Vercel bot challenge for non-browser clients; no key-free official JSON/RSS; LSE/Investegate/Companies House are NOT used as Aquis substitutes). Universe: partial unofficial ticker.app AQSE mirror backfills names/exchange/ISIN (not verified complete). News not wired yet (AQ-3 pending). Finnhub is US-only and never queried for AQ.",
};
...
function regionForMarket(market) { return ({us:"United States",jp:"Japan",hk:"Hong Kong",cn:"China",kr:"Korea",uk:"United Kingdom",tw:"Taiwan",ca:"Canada",au:"Australia",be:"Belgium",fr:"France",de:"Germany",nl:"Netherlands",it:"Italy",es:"Spain",sg:"Singapore",ch:"Switzerland",pl:"Poland",se:"Sweden",aq:"Aquis (AQSE)"})[market] || "Unavailable"; }
