...
const MARKET_HINTS = {
  ...
  be: "BE market (Euronext Brussels): root tickers strip .BR/.BRU/.EBR; Belgian ISINs kept as-is. Disclosure, universe, and news connectors are not wired yet (BE-1 through BE-5 in progress); BE companies are added as unmapped. Finnhub is US-only and never queried for BE.",
