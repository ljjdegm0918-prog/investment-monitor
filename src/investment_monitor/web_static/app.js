...
const MARKET_HINTS = {
  ...
  de: "DE market (XETRA/Frankfurt): root tickers strip .DE/.XETRA/.XE/.F; German ISINs kept as-is. EQS/DGAP disclosure is stubbed (status: stub, not wired yet); news sources are stubs (Yahoo DE / Google News DE); universe not wired in DE-0. Companies stay unmapped. Finnhub is US-only.",
};
