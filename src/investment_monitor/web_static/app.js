...
const MARKET_HINTS = {
  ...
  aq: "AQ market (Aquis Stock Exchange, AQSE): root tickers strip .AQ; AQSE mnemonics kept as-is; ISINs (GB/IE/other) kept as-is. Companies are added as unmapped (no SEC mapping). Disclosure/news/universe connectors are NOT wired yet (AQ-1 to AQ-5 pending; official aquis.eu pages sit behind a Vercel bot challenge for non-browser clients; LSE/Investegate/Companies House are NOT used as Aquis substitutes). Finnhub is US-only and never queried for AQ.",
};
