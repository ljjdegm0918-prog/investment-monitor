...
const MARKET_HINTS = {
  ...
  es: "ES market (BME / Bolsa de Madrid): root tickers strip .MC/.MAD/.BME; Spanish ISINs kept as-is. CNMV official RSS disclosure (hechos relevantes: IP + OIR) is connected and key-free; matching needs the ES universe name/ISIN (universe cache lands in ES-2). Universe and news connectors are not wired yet (ES-2 through ES-5 in progress); ES companies are added as unmapped. Finnhub is US-only and never queried for ES.",
};
