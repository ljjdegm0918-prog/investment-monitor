...
const MARKET_HINTS = {
  ...
  pl: "PL market (GPW / Warsaw): root tickers strip .WA/.WSE/.GPW; Polish ISINs kept as-is. Disclosure is NOT wired (PL-1 spike: GPW/ESPI unreachable from this network; EQS empty for Polish ISINs; KNF no per-issuer feed; no paid GPW data products). Universe: official GPW HTML directories (GPW Main Market ~403 + NewConnect ~349; breadth only, never in feed; backfills name/board/ISIN on add-company). News: Yahoo Finance PL + Google News PL (key-free RSS; .WA at request time; loosely related possible - a PKO.WA Google query can include football items). PL companies are added as unmapped. Finnhub is US-only and never queried for PL.",
};
...
function regionForMarket(market) { return ({us:"United States",jp:"Japan",hk:"Hong Kong",cn:"China",kr:"Korea",uk:"United Kingdom",tw:"Taiwan",ca:"Canada",au:"Australia",be:"Belgium",fr:"France",de:"Germany",nl:"Netherlands",it:"Italy",es:"Spain",sg:"Singapore",ch:"Switzerland",pl:"Poland"})[market] || "Unavailable"; }
