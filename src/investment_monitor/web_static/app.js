...
const MARKET_HINTS = {
  ...
  ch: "CH market (SIX Swiss Exchange): root tickers strip .SW/.SWX/.S; Swiss ISINs kept as-is. Disclosure, universe, and news connectors are not wired yet (CH-1 through CH-5 in progress); CH companies are added as unmapped. Finnhub is US-only and never queried for CH.",
};
