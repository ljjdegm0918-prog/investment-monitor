...
const MARKET_HINTS = {
  ca: "CA market skeleton: Canadian symbols normalize to root tickers (.TO/.TSX/.V/.TSXV/.CN/.NE/.NEO suffixes are stripped; board goes into exchange later). Canadian disclosure, universe, and news connectors are not wired yet (CA-1 through CA-5); CA companies are added as unmapped. Finnhub is US-only and never queried for CA.",
