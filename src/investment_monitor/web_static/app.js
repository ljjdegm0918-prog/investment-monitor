...
const MARKET_HINTS = {
  ...
  pl: "PL market (GPW / Warsaw): root tickers strip .WA/.WSE/.GPW; Polish ISINs kept as-is. Disclosure, universe, and news connectors are not wired yet (PL-1 through PL-5 in progress); PL companies are added as unmapped. Finnhub is US-only and never queried for PL.",
};
