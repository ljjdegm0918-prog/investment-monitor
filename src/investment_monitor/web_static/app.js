...
const MARKET_HINTS = {
  ...
  au: "AU market: root tickers strip .AX/.ASX. ASX announcements via key-free research API (latest 5 per company; may change). Universe backfills names/board. News: Yahoo Finance AU + Google News AU. Community: HotCopper (hotcopper_au) registered stub — public boards return HTTP 403 Cloudflare to bots; collect() empty until a stable public feed exists. Finnhub is US-only.",
