...
const MARKET_HINTS = {
  au: "AU market skeleton: Australian symbols normalize to root tickers (.AX/.ASX suffixes are stripped; board goes into exchange later). Australian disclosure, universe, and news connectors are not wired yet (AU-1 through AU-5); AU companies are added as unmapped. Finnhub is US-only and never queried for AU.",
