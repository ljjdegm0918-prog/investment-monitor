...
const MARKET_HINTS = {
  ...
  trq: "TRQ market (Turquoise, LSEG MTF): second Alternative European Equities venue after Cboe Europe (market=cxe) - NOT the whole package and NOT AQSE/LSE/Eurex. Common symbols are kept uppercased (AZN stays AZN); .TRQ/.TRQX/.TQEX suffixes stripped at add time; ISINs kept as-is. Companies are added as unmapped (no SEC mapping). Disclosure/news/universe connectors are NOT wired yet (TRQ-1 to TRQ-5 pending; re-test 2026-08-11: turquoise.com parked, turquoise.eu is an unrelated company, tradeturquoise.com redirects to a JS-only LSE SPA, old reference-file CSV URLs return 404). Finnhub is US-only and never queried for TRQ.",
};
